#' This function is used to estimate scale parameter \eqn{\yita_f} from the model residues under specified assumption of distribution of error. So the input includes degree of freedom and model residues. 
#' 
#' @Title Estimation of scale parameter \eqn{\yita_f} using tQMLE
#'
